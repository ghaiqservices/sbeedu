...
$sql =  "SELECT courseID, courseName, courseDesc, courseUnits, courseMode, DATE(FROM_UNIXTIME(unix_timestamp(courseStart))) as dateStart, DATE(FROM_UNIXTIME(unix_timestamp(courseExpiry))) as dateExpiry, courseProcess, courseDocsName, courseDocsUrl, courseStatus, dateTime";
$sql.=" FROM courses";
...
while($row=mysqli_fetch_array($query)){  
	...
	$nestedData[] = $row["dateStart"];
	$nestedData[] = $row["dateExpiry"];
